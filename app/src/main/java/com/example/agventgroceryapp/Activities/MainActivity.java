...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.category:
                Intent intent2 = new Intent(act, CategoryActivity.class);
                startActivity(intent2);
                break;

            case R.id.newProducts:
            Intent intent3 = new Intent(act, NewProductsActivity.class);
            startActivity(intent3);
            break;

            case R.id.myOrders:
                Intent intent4 = new Intent(act, MyOrdersActivity.class);
                startActivity(intent4);
                break;

            case R.id.cart:
                Intent intent5 = new Intent(act, CartActivity.class);
